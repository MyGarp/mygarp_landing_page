...
const Login = () => {
  return (
   ...
   <div className='bg-[#224F34] px-8 py-4 md:w-[620.21px] h-[500px] w-[400px] ' >
    ...
    <div>
      <h4 className='text-white text-[14px] mb-2 font-poppins  pl-2 mt-2'>Email</h4>
   ...
   <div>
      <h4 className='text-white text-[14px] mb-2  left-2 md:pl-2 font-poppins mt-2'>Password</h4>
      <div className="border-[#E2E8F0] w-auto h-[40px] border relative rounded-md  ">
            <input
              type="text"
      ...
      {/* second_input Login */}
   <div>
      <h4 className='text-white text-[14px] font-poppins mb-2 md:pl-2  mt-2'>Login As</h4>
      <div className="border-[#E2E8F0] w-auto h-[40px] border relative rounded-md ">
            <input
              type="text"
            ...
            />
            <ChevronDown size={18} color="white" className="  text-red-500 absolute md:left-[32.9rem] left-[19rem] md:bottom-[3px] bottom-[6px]"/>
            <p className="mt-4 text-white text-[12px] font-poppins flex items-center justify-end ">Forgot Password?</p>
    ...
    <Button btnStyle="px-12 py-1 text-white font-bold text-[14px]  rounded-md  bg-[#224F34] border border-white flex items-center justify-center m-auto" btnText="Login"/>
    
    <Link to="/signup">
    <p className="mt-4 text-white text-[12px] font-poppins text-center ">Dont have an account signup</p>
    </Link>
    </div>
   </div>
   {/* end */}
