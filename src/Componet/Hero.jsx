...
const Hero = () => {
  return (
    ...
    <section className='py-2 md:px-28 px-8   bg-[#C2EFD4] md:h-auto '>
       ...
       <div>
        <h1 className='font-semibold text-hero_green lg:text-[55px] md:text-[70px] text-[36px]  lg:w-[75%] md:w-[100%] w-[80%] mb-4 font-rufina '>
        ...
        <Button btnText="GET STARTED" btnStyle="text-white font-bold lg:text-[12px] md:text-[28px] text-[18px] lg:py-3 py-4  lg:px-8 md:py-4 md:px-12 px-8 md:mb-12 mb-4  bg-hero_green rounded-sm"/>
       </div>
       {/* first container */}
       <div className='pb-8 '>
